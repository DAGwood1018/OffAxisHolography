...
public:
    OffAxisFilter(py::array_t<int, py::array::c_style | py::array::forcecast> n, py::array_t<int, py::array::c_style | py::array::forcecast> roi, 
    ...
    Eigen::MatrixXd operator()(py::array_t<uint8_t, py::array::c_style | py::array::forcecast> fringes);
    void filter();
    int size();
    int threads_in_use();
    void show_input();
