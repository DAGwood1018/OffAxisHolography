...
PYBIND11_MODULE(holo_lib, m) {
     py::class_<OffAxFilter>(m, "OffAxFilter")
        ...
        .def("forwards", static_cast<void (OffAxFilter::*)()>(&OffAxFilter::forwards))
        .def("backwards", static_cast<void (OffAxFilter::*)()>(&OffAxFilter::backwards))
        ...
        .def("show_filtered", &OffAxFilter::show_filtered)
        ;
}